...
Data = importdata('KF_DW_FDIAI.txt');
...
inc1_thd=zeros(1,136);
inc2_thd=zeros(1,136);
for i=1:136
   inc1_thd(i)=2e-4;
   inc2_thd(i)=1.5e-3;
end
...
hold on;
t21=text(125,pos_FDIAI_DW(130),'OFF');
set(t21,'Interpreter','latex','FontSize',Fonts);
hold off;
saveas(fig1,'dwm11','pdf');
...
set(le12,'Interpreter','latex');
hold on;
t21=text(125,ang_FDIAI_DW(130)-0.15,'OFF');
set(t21,'Interpreter','latex','FontSize',Fonts);
hold off;
saveas(fig2,'dwm12','pdf');
